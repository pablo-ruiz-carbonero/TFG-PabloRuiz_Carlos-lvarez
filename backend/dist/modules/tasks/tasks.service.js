...
let TasksService = class TasksService {
    ...
    async findAllByCrop(cropId, userId) {
    ...
    async create(createTaskDto, userId) {
        ...
        if (!crop) {
            throw new common_1.NotFoundException('Cultivo no encontrado o no autorizado');
        }
        const task = this.taskRepository.create({
            ...createTaskDto,
            cultivo: { id: createTaskDto.cultivo_id },
        });
    ...
    async getPendingCount(cropId, userId) {
